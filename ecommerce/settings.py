...
DEFAULT_FROM_EMAIL = os.environ.get('DEFAULT_FROM_EMAIL', 'DripShop <noreply@dripshop.com>')

# Reconfigure stdout for Windows console UTF-8 support when printing emails
import sys
